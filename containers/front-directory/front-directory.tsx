        ...
        <div className="container bg-gray-400 rounded-md mx-auto align-middle mt-16 ">
            <div className="container justify-center text-center pb-8 pt-10 ">
                <div id="brand" className="pb-8">
                    <span className="text-8xl decoration-clone text-transparent bg-gradient-to-b from-indigo-600 to-green-400 bg-clip-text font-semibold">League Scout</span>
                </div>
                <p className=" text-3xl subpixel-antialiased w-full ">Enter Summoner Name</p>
                <div className="my-8">
                    <form>
